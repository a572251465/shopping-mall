...
public class QrtzLocksController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("mallproduct:qrtzlocks:list")
    ...
    @RequiresPermissions("mallproduct:qrtzlocks:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("mallproduct:qrtzlocks:save")
    ...
    @RequiresPermissions("mallproduct:qrtzlocks:update")
    ...
    @RequiresPermissions("mallproduct:qrtzlocks:delete")
